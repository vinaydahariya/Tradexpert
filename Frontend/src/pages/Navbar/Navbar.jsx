    ...
    <>
      <div className="px-2 py-3 border-b z-50 bg-background bg-opacity-0 sticky top-0 left-0 right-0 flex justify-between items-center">
              ...
              <SheetHeader>
                <SheetTitle>
                  <div className="text-3xl flex justify-center  items-center gap-1">
                    ...
                    <div>
                      <span className="font-bold text-orange-700">Tradexpert</span>
                      <span></span>
                    </div>
                  </div>
                </SheetTitle>
        ...
        <div className="flex items-center gap-2 cursor-pointer" onClick={handleNavigate}>
          <span className="font-medium">{auth?.user?.fullName || "User"}</span>

          <Avatar>
            {auth?.user?.picture ? (
              <AvatarImage src={auth.user.picture} alt={auth.user.fullName} />
            ) : (
              <AvatarFallback>
